...
namespace ams::ldr::hoc::pcv::mariko {
    ...
    void MemMtcTableAutoAdjust(MarikoMtcTable *table) {
        ...
        WRITE_PARAM_ALL_REG(table, emc_rp, rp_cyc);
        ...
        WRITE_PARAM_ALL_REG(table, emc_tcke, GET_CYCLE_CEIL(tXP) + 2);
        ...
        WRITE_PARAM_ALL_REG(table, emc_pdex2cke, GET_CYCLE_CEIL(1.75) - 2);
